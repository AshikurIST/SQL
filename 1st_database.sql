...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 23, 2024 at 05:13 PM
...
CREATE TABLE `account` (
  `account_number` varchar(20) NOT NULL DEFAULT 'not null',
...
INSERT INTO `branch` (`branch_name`, `branch_city`, `asset`) VALUES
